...
INCLUDES_DEP_PLATFORM_FILE_NAME=	$(CONFIG_MODULE_DEP_FILE_NAME)/$(PLATFORM)
...
ifneq ($(INCLUDES_DEPENDENCIES_PLAT_EXISTENCE), )
...
$(warning INCLUDES_MODULES_LIST: $(INCLUDES_MODULES_LIST))
else ifneq ($(INCLUDES_DEPENDENCIES_EXISTENCE), )
INCLUDES_DEPENDENCIES_COMMAND=	cat \
					$(INCLUDES_DEP_GENERIC_FILE_NAME)
