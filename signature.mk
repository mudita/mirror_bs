...
SIGNATURE_ASM_GCOV_SUFFIX=	$(SIGNATURE_SUFFIX).$(CONFIG_GCOV_FILE_EXT)
SIGNATURE_ASM_GCDA_SUFFIX=	$(SIGNATURE_SUFFIX).$(CONFIG_GCDA_FILE_EXT)

SIGNATURE_C_OBJECT_SUFFIX=	$(SIGNATURE_SUFFIX).$(CONFIG_C_OBJECT_FILE_EXT)
SIGNATURE_C_GCOV_SUFFIX=	$(SIGNATURE_SUFFIX).$(CONFIG_GCOV_FILE_EXT)
SIGNATURE_C_GCDA_SUFFIX=	$(SIGNATURE_SUFFIX).$(CONFIG_GCDA_FILE_EXT)
