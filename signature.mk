...
SIGNATURE_VERSION_COMMAND=	$(PATH_EXPORT_COMMAND) && \
				$(PLATFORM_C_COMPILER) \
					$(SIGNATURE_VERSION_SWITCH)

SIGNATURE_ARCHITECTURE_COMMAND=	$(PATH_EXPORT_COMMAND) && \
				$(PLATFORM_C_COMPILER) \
...
SIGNATURE_SUFFIX=		$(PLATFORM_HOST_C_COMPILER)_$(SIGNATURE_COMPILER_VERSION)_$(SIGNATURE_TARGET_ARCHITECTURE)
...
SIGNATURE_APPLICATION_TEST_SUFFIX=	$(UNIT_TEST_C_SUFFIX)_$(SIGNATURE_SUFFIX)
