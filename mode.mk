...
MODE_APPLICATION_INSTALL_DIR=		$(DIRS_APPLICATIONS_DIR)/$*/$(DIRS_INSTALL_DIR)
MODE_APPLICATION_MTRACE_FILE=		$(MODE_APPLICATION_INSTALL_DIR)/$(CONFIG_MTRACE_FILE_NAME)
MODE_APPLICATION_EXECUTABLE_FILE=	$(MODE_APPLICATION_INSTALL_DIR)/$*_$(SIGNATURE_SUFFIX)

MODE_MTRACE_COMMAND=			test \
						-f \
					$(MODE_APPLICATION_MTRACE_FILE) && \
					mtrace \
						$(MODE_APPLICATION_EXECUTABLE_FILE) \
						$(MODE_APPLICATION_MTRACE_FILE) || \
					true
