...
MODE_APPLICATION_MTRACE_FILE=		$(INSTALL_PLATFORM_DIR)/$(CONFIG_MTRACE_FILE_NAME)
MODE_APPLICATION_OS_LOG_FILE=		$(INSTALL_PLATFORM_DIR)/$(CONFIG_OS_LOG_FILE_NAME)
MODE_APPLICATION_OS_STATS_FILE=		$(INSTALL_PLATFORM_DIR)/$(CONFIG_OS_STATS_FILE_NAME)
