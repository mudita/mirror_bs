...
COVERAGE_SOURCES_TEST_CONDITION=	$(wildcard \
						$(COVERAGE_CHECK_MODULE_RELATIVE_DIR))

# TODO: If src exists, command should be ls.
COVERAGE_SOURCES_TEST_TRUE=		echo \
						$($(CONFIG_MODULE_PREFIX))

# TODO: If src does not exists, command should be true or similar.
COVERAGE_SOURCES_TEST_FALSE=		true

# INFO: Test of existence for build system script.
COVERAGE_SOURCES_WILDCARD_TEST=		$(if \
						$(COVERAGE_SOURCES_TEST_CONDITION), \
						$(COVERAGE_SOURCES_TEST_TRUE), \
						$(COVERAGE_SOURCES_TEST_FALSE))

COVERAGE_SOURCES_TEST=			$(shell	\
						$(COVERAGE_SOURCES_WILDCARD_TEST))
...
$(error COVERAGE_MODULES_WITH_SOURCES_LIST: $(COVERAGE_MODULES_WITH_SOURCES_LIST))
