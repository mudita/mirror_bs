...
COVERAGE_DEP_PLATFORM_FILE_NAME=	$(CONFIG_MODULE_DEP_FILE_NAME)/$(PLATFORM)
...
ifneq ($(COVERAGE_DEPENDENCIES_PLAT_EXISTENCE), )
COVERAGE_DEPENDENCIES_COMMAND=	find \
...
else ifneq ($(COVERAGE_DEPENDENCIES_EXISTENCE), )
