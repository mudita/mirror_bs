...
COVERAGE_SOURCES_TEST_CONDITION=	$(wildcard \
						$(COVERAGE_CHECK_MODULE_DIR))

# TODO: If src exists, command should be ls.
COVERAGE_SOURCES_TEST_TRUE=		$($(CONFIG_MODULE_PREFIX))
...
#COVERAGE_CHECK_SOURCES_COMMAND=		ls \
#						../../$(COVERAGE_CHECK_MODULE_DIR)

#COVERAGE_CHECK_SOURCES=			$(shell \
#						$(COVERAGE_CHECK_SOURCES_COMMAND))
