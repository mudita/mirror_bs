...
ifneq ($(wildcard $(TRANSFER_SRC_FILE_NAME)), )
...
ifneq ($(wildcard $(TRANSFER_INCLUDES_FILE_NAME)), )
...
TRANSFER_CLEAN_SRC_LIST=		$(addprefix \
						$(CLEAN_PREFIX)_$(DIRS_SOURCES_DIR)/, \
						$(TRANSFER_SRC_LIST))
