...
INSTALL_APPLICATION_ELF_FILE=	$(DIRS_INSTALL_DIR)/$(PLATFORM)/$(SIGNATURE_APPLICATION_FILE_NAME)
INSTALL_TOOL_ELF_FILE=		$(DIRS_INSTALL_DIR)/$(PLATFORM)/$(SIGNATURE_TOOL_FILE_NAME)
