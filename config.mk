...
# INFO: Rebuild rules.
CONFIG_REBUILD_RULE=			rebuild
CONFIG_REBUILD_FULL_RULE=		$(CONFIG_REBUILD_RULE)_$(CONFIG_FULL_SUFFIX)
CONFIG_REBUILD_DEEP_RULE=		$(CONFIG_REBUILD_RULE)_$(CONFIG_DEEP_SUFFIX)
...
CONFIG_ALLOC_FILE_NAME=			alloc.$(CONFIG_CFG_EXT)
...
CONFIG_NON_STANDARD_FILE_NAME=		non_standard.$(CONFIG_LIST_EXT)
CONFIG_EMPTY_DIRS_FILE_NAME=		empty_dirs.$(CONFIG_LIST_EXT)
CONFIG_INCORRECT_INCLUDES_FILE_NAME=	incorrect_includes.$(CONFIG_LIST_EXT)
...
CONFIG_DEPLOY_USERNAME_FILE_NAME=	deploy.username
CONFIG_DEPLOY_REPONAME_FILE_NAME=	deploy.reponame
