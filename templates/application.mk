...
$(UNIT_TEST_C_ENTRY_FILE): \
	...
	cd \
		$(DIRS_UNIT_TEST_DIR) && \
	../$(RELATIVE_ROOT_DIR)/$(DIRS_APPLICATIONS_DIR)/embunit_bcuppa/$(DIRS_INSTALL_DIR)/$(PLATFORM_HOST_ARCHITECTURE)/embunit_bcuppa_$(SIGNATURE_SUFFIX) \
		$*_$(UNIT_TEST_C_SUFFIX:%.c=%) \
