...
# INFO: 
#FLAGS_POSITION_INDEPENDENT_CODE=	-fPIC
FLAGS_POSITION_INDEPENDENT_CODE=

FLAGS_C_COMPILER_TEMP_LIST=	$(FLAGS_POSITION_INDEPENDENT_CODE)
FLAGS_CPP_COMPILER_TEMP_LIST=	$(FLAGS_POSITION_INDEPENDENT_CODE)
...
LIBS_DEPENDENCIES_EXISTENCE=	$(wildcard \
					$(CONFIG_FILTER_OUT_FLAGS_FILE_NAME))
