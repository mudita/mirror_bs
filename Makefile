...
$(UNIT_TEST_SOURCES_GEN_MOD_STANDARD_LIST): \
		$(UNIT_TEST_SOURCES_GEN_MOD_PREFIX)_%:
	make \
		INCLUDER_PATH=$(INCLUDER_PATH) \
		INCLUDER_BINARY_PATH=$(INCLUDER_BINARY_PATH) \
		PLATFORM=$(shell \
...
$(UNIT_TEST_SOURCES_GEN_MOD_NONSTANDARD_LIST): \
		$(UNIT_TEST_SOURCES_GEN_MOD_PREFIX)_%:
	make \
		INCLUDER_PATH=$(INCLUDER_PATH) \
		INCLUDER_BINARY_PATH=$(INCLUDER_BINARY_PATH) \
...
$(UNIT_TEST_SOURCES_GEN_APP_STANDARD_LIST): \
		$(UNIT_TEST_SOURCES_GEN_APP_PREFIX)_%: \
		$(CONFIG_APPLICATION_PREFIX)_%
	make \
		INCLUDER_PATH=$(INCLUDER_PATH) \
		INCLUDER_BINARY_PATH=$(INCLUDER_BINARY_PATH) \
...
$(UNIT_TEST_SOURCES_GEN_APP_NONSTANDARD_LIST): \
		$(UNIT_TEST_SOURCES_GEN_APP_PREFIX)_%: \
		$(CONFIG_APPLICATION_PREFIX)_%
	make \
		INCLUDER_PATH=$(INCLUDER_PATH) \
