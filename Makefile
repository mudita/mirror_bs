...
# TODO: These veriables cannot be passed here! Try solve it like in launcher.
$(CLEAN_DEEP_APPLICATIONS_PLATFORMS_NONSTANDARD_LIST): \
		$(CLEAN_DEEP_APPLICATION_PREFIX)_%:
	make \
		INCLUDER_PATH=$(INCLUDER_PATH) \
		INCLUDER_BINARY_PATH=$(INCLUDER_BINARY_PATH) \
		PLATFORM=$(shell \
...
# TODO: These veriables cannot be passed here! Try solve it like in launcher.
$(CLEAN_FULL_APPLICATIONS_PLATFORMS_NONSTANDARD_LIST): \
		$(CLEAN_FULL_APPLICATION_PREFIX)_%:
	make \
		INCLUDER_PATH=$(INCLUDER_PATH) \
		INCLUDER_BINARY_PATH=$(INCLUDER_BINARY_PATH) \
		PLATFORM=$(shell \
...
$(REBUILD_DEEP_TOOLS_PLATFORMS_LIST): \
		$(REBUILD_DEEP_TOOL_PREFIX)_%: \
		$(CLEAN_DEEP_TOOL_PREFIX)_% \
		$(CONFIG_TOOL_PREFIX)_%

$(REBUILD_DEEP_MODULES_PLATFORMS_LIST): \
		$(REBUILD_DEEP_MODULE_PREFIX)_%: \
		$(CLEAN_DEEP_MODULE_PREFIX)_% \
		$(CONFIG_MODULE_PREFIX)_%

$(REBUILD_DEEP_APPLICATIONS_PLATFORMS_LIST): \
		$(REBUILD_DEEP_APPLICATION_PREFIX)_%: \
		$(CLEAN_DEEP_APPLICATION_PREFIX)_% \
		$(CONFIG_APPLICATION_PREFIX)_%

$(REBUILD_FULL_TOOLS_PLATFORMS_LIST): \
		$(REBUILD_FULL_TOOL_PREFIX)_%: \
		$(CLEAN_FULL_TOOL_PREFIX)_% \
		$(CONFIG_TOOL_PREFIX)_%

$(REBUILD_FULL_MODULES_PLATFORMS_LIST): \
		$(REBUILD_FULL_MODULE_PREFIX)_%: \
		$(CLEAN_FULL_MODULE_PREFIX)_% \
		$(CONFIG_MODULE_PREFIX)_%

$(REBUILD_FULL_APPLICATIONS_PLATFORMS_LIST): \
		$(REBUILD_FULL_APPLICATION_PREFIX)_%: \
		$(CLEAN_FULL_APPLICATION_PREFIX)_% \
		$(CONFIG_APPLICATION_PREFIX)_%
...
$(CONFIG_AUTO_SYNC_RULE):
	make \
		...
		$(FLAGS_MAKE_LIST) \
		-C \
		$(DIRS_APPLICATIONS_DIR)/qemu_gnuarmeclipse \
		$(CONFIG_MAKEFILE_FILE_NAME) \
		$(CONFIG_ALL_RULE)
	make \
		INCLUDER_PATH=$(INCLUDER_PATH) \
